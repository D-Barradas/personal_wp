...
<section class="hero-section" style="min-height: 400px;">
  <div class="hero-content">
    ...
    <p class="subtitle">Education, Certifications & Recognition</p>
  </div>
</section>
...
<section class="section-container alternate">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; max-width: 1200px; margin: 0 auto;">
    ...
    <div class="achievement-card highlight">
      ...
      <h3 class="achievement-title">NVIDIA Ambassador</h3>
      <p class="achievement-description">
        Recognized technical leader advancing GPU computing, CUDA programming, and AI/ML solutions in the scientific community.
      </p>
    </div>

    <div class="achievement-card highlight">
      <div class="achievement-icon">👨‍🏫</div>
      <h3 class="achievement-title">The Carpentries Instructor</h3>
      <p class="achievement-description">
        Certified instructor authorized to teach foundational data, software, and library skills to research communities worldwide.
      </p>
    </div>

    <div class="achievement-card">
      <div class="achievement-icon">🎯</div>
      <h3 class="achievement-title">NVIDIA Model Parallelism</h3>
      <p class="achievement-description">
        Building and deploying large neural networks using advanced model parallelism techniques on NVIDIA GPU infrastructure.
      </p>
    </div>

    <div class="achievement-card">
      <div class="achievement-icon">📊</div>
      <h3 class="achievement-title">Fundamentals of Accelerated Data Science</h3>
      <p class="achievement-description">
        NVIDIA certification in GPU-accelerated data science workflows, RAPIDS library, and high-performance analytics.
      </p>
    </div>

    <div class="achievement-card">
      <div class="achievement-icon">🤖</div>
      <h3 class="achievement-title">Generative Adversarial Networks (GANs)</h3>
      <p class="achievement-description">
        DeepLearning.AI specialization covering GAN architectures, training techniques, and applications in image generation.
      </p>
    </div>

    <div class="achievement-card">
      <div class="achievement-icon">☸️</div>
      <h3 class="achievement-title">Google Kubernetes Engine</h3>
      <p class="achievement-description">
        Coursera certification in container orchestration, deploying applications, and managing scalable cloud infrastructure.
      </p>
    </div>
...
<section class="section-container">
  <h2 class="section-title">Additional Credentials</h2>
